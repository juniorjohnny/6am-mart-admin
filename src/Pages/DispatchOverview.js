    ...
    <>
      ...
      <div className="flex flex-wrap gap-4 justify-center md:justify-between mt-8">
        ...
        <div className="w-full md:w-[60%] max-w-[800px]">
          ...
          <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/new-img/deliveryman/newly.svg" alt="Inactive and Suspended" className="w-16 h-16 mr-4" />
          <div>
        ...
        <div className="p-6 bg-white rounded-lg shadow-md flex items-center">
          <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/new-img/deliveryman/active.svg" alt="Fully Booked Delivery Man" className="w-16 h-16 mr-4" />
          <div>
            <h3 className="text-xl font-bold">0</h3>
        ...
        <div className="p-6 bg-white rounded-lg shadow-md flex items-center">
          <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/new-img/deliveryman/in-active.svg" alt="Available to Assign Orders" className="w-16 h-16 mr-4" />
          <div>
            <h3 className="text-xl font-bold">5</h3>
      ...
      <div style={{width: "100%"}}><iframe width="100%" height="600" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=23.282237154516917,77.44332197116657+(Boostup%20Digital)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps systems</a></iframe></div>
    </>
  );
};
