        ...
        <div className='h-full md:w-auto w-auto lg:w-full'>
            <div className='flex flex-col gap-3'>
                ...
                <div className='flex flex-col shadow rounded px-6 py-6 gap-2'>
                    ...
                    <h1 className='text-[2.1vh]'>By turning the ‘Maintenance Mode’ ON all your apps and customer website will be disabled temporarily. Only the Admin Panel Admin Landing Page & Store Panel will be functional.</h1>
                </div>
                ...
                <div className='py-5 px-5 shadow rounded flex flex-col  gap-3'>
                    <div className='flex flex-col md:flex-row gap-3'>
                        <div className='flex flex-col gap-1 w-72 text-[2vh]'>
                            <h1>Company Name</h1>
                            <input className='h-11 border p-3 rounded' placeholder='New company' type="text" />
                        </div>
                        <div className='flex flex-col gap-1 w-72 text-[2vh]'>
                            <h1>Email</h1>
                            <input className='h-11 border p-3 rounded' placeholder='Ex: ex@example.com' type="email" />
                        </div>
                        <div className='flex flex-col gap-1 w-72 text-[2vh]'>
                            <h1>Phone</h1>
                            <input className='h-11 border p-3 rounded' placeholder='New company' type="tel" />
                        </div>
                        <div className='flex flex-col gap-1 w-72 text-[2vh]'>
                            <h1>Country</h1>
                    ...
                    <div className='flex md:flex-row flex-col gap-3 items-center'>
                        <div className='flex flex-col gap-3 w-full'>
                            <div className='flex flex-col gap-2 w-72 md:w-auto text-[2vh]'>
                                <h1>Address</h1>
                                <textarea className='resize-none border h-24' name="" id="" cols="10" rows="10"></textarea>
                            </div>
                            <div className='flex md:flex-row flex-col gap-5 text-[2vh]'>
                                <div className='flex flex-col gap-1 w-full text-[2vh]'>
                                    <h1>Latitude</h1>
                                    <input className='h-11 border p-3 rounded w-fit md:w-auto' placeholder='New company' type="text" />
                                </div>
                                <div className='flex flex-col gap-1 w-full text-[2vh]'>
                                    <h1>Longitude</h1>
                                    <input className='h-11 border p-3 rounded w-fit md:w-auto' placeholder='New company' type="text" />
                            ...
                            <div className='flex flex-col md:flex-row text-[2vh] h-fit md:items-center'>
                                    ...
                                    <div className='md:h-[100%] md:w-[90%] border-2 p-1 border-dashed rounded flex items-center'>
                                        <form className='' action="">
                                            <div className='relative'>
                                                <input id="dropzone-file" type="file" className="absolute md:h-full md:w-full h-fit w-fit opacity-0" />
                                ...
                                <div className='flex flex-col gap-2 md:h-full h-fit'>
                                    ...
                                    <div className=' border-2 p-1 border-dashed rounded w-fit'>
                                        <form className='' action="">
                                            <div className='relative '>
                                                <input id="dropzone-file" type="file" className="absolute h-full w-full opacity-0" />
                        ...
                        <div className='w-[90%] h-fit border py-3 px-3 border-green-500 rounded'>
                            <iframe width="100%" height="300" scrolling="no" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Bhopal+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
                ...
                <div className="py-5 px-5 shadow rounded grid md:grid-cols-3 gap-5" >
                    ...
                    <div className='flex flex-col w-full justify-between'>
                        ...
                        <textarea className='h-11 border p-3 rounded' placeholder='Ex: Copyright Text' type="text" />
                    </div>
                    <div className='flex flex-col w-full justify-between'>
                        <h1>Cookies Text</h1>
                        <textarea className='h-11 border p-3 rounded' placeholder='Ex: Cookies Text' type="text" />
                    </div>
                </div>
                ...
                <div className="py-5 px-5 shadow rounded grid md:grid-cols-3 gap-5" >
                    <div className='flex flex-col w-full justify-between'>
                        ...
                        <input className='h-11 border p-3 rounded text-[2vh]' placeholder='Ex: 10' type="text" />
                    </div>
                    <div className='flex flex-col w-full justify-between'>
                        <h1>Commission Rate On Delivery Charge (%)</h1>
                        <input className='h-11 border p-3 rounded text-[2vh]' placeholder='Ex: 5' type="text" />
                    </div>
                    <div className='flex flex-col w-full justify-between'>
                ...
                <div className='flex flex-col shadow-lg bg-slate-100'>
                    ...
                    <button className='px-8 py-2 rounded-md bg-gray-200 font-semibold'>Reset</button>
                    <button className='px-6 py-2 rounded-md bg-cyan-500 text-white '>Save Changes</button>
                    </div>
                </div>
            </div>
        </div>
