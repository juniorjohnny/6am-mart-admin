...
import {
  ...
  const tableData = [
    {
      ...
      "image_url": "https://6ammart-admin.6amtech.com/storage/app/public/product/2022-03-23-623aa83cbad9b.png",
      "market": "Eco Market",
  ...
  },
  {
      "id": 2,
      "name": "Strawberry",
      "image_url": "https://6ammart-admin.6amtech.com/storage/app/public/product/2022-03-22-62399aae05abb.png",
...
<div class="card-header py-3 border-b-0 md:flex md:flex-wrap md:items-center md:justify-between ">
  <form class="flex items-center">
    ...
    <div className=" w-full md:w-1/4 mt-2 hover:text-[#24bac3]  ">
      <select name="zone_id" className="form-select border border-[#24bac3] p-2 py-3  px-10  w-full rounded focus:outline-[#24bac3]" id="zone">
     ...
     {/* Zone select */}
     <div className=" w-full md:w-1/4 mt-2  hover:text-[#24bac3]  ">
      <select name="zone_id" className="form-select border-[#24bac3] border p-2 py-3  px-10  w-full rounded focus:outline-[#24bac3] " id="zone">
        <option value="all">All Zones</option>
        <option value="1">Main Demo Zone</option>
