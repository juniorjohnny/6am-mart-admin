  ...
  const tableData = [
    {
      "sl":1,
      "id": "#1002",
      "deliveryManLink": "https://6ammart-admin.6amtech.com/admin/users/delivery-man/preview/1",
  ...
  return (
    <div>
      ...
      <h1 className="font-bold text-2xl flex items-center mb-4">
            ...
            <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/report/new/disburstment.png" className="w-[25px] " alt="" />          </span>
        ...
        <div className="lg:col-span-1">
          <div className="grid grid-cols-1 sm:grid-cols-3 items-center  gap-2">
            <div className="sm:col-span-1 ">
              <a href="#" className="block bg-gray-100 border rounded-sm shadow-sm py-10 p-4 ">
              <div className="info-icon flex justify-end  " data-toggle="tooltip" data-placement="top" title="When the order is successfully delivered full order amount goes to this section.">
                ...
                <h3 className="title text-green-600 text-2xl py-6 text-center font-extrabold  ">$ 940.91</h3>
                <h6 className="subtitle  text-center">Pending <span>Disbursementsn</span></h6>
            ...
            <div className="sm:col-span-1">
              ...
              <div className="info-icon flex justify-end " data-toggle="tooltip" data-placement="top" title="If the order is successfully refunded  the full order amount goes to this section without the delivery fee and delivery tips.">
                ...
                <div className='flex justify-center items-center'>
                <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/report/new/trx5.png" className=" w-24 " alt="report/new" />
                </div>
                
                <h3 className="title text-2xl py-6 text-center  font-extrabold">$ 000.00</h3>
                <h6 className="subtitle  text-center ">Completed Disbursements</h6>
              </a>
            </div>
            <div className="sm:col-span-1">
              <a href="#" className="block bg-gray-100 rounded-md shadow-md py-10 p-4  ">
              <div className="info-icon flex justify-end " data-toggle="tooltip" data-placement="top" title="If the order is successfully refunded  the full order amount goes to this section without the delivery fee and delivery tips.">
                ...
                <h3 className="title text-2xl py-6 text-center text-red-600 font-extrabold">$ 000.91</h3>
                <h6 className="subtitle  text-center ">Canceled Transactions</h6>
              </a>
            </div>
          </div>
        </div>
   ...
   <div className=" w-full md:w-1/4 mt-2  ">
    ...
    <div className=" w-full md:w-1/4 sm:w-auto  border text-center border-[#24bac3] bg-[#006161] text-white mt-3 rounded-md">
      ...
      <div className="md:flex  items-center justify-between md:gap-4 mt-5 border  ">
        ...
        <span>
        Expense Lists
          <span className="badge badge-soft-dark ml-2 text-sm bg-gray-300 p-1">7</span>
        </span>
      </h1>
    ...
    <table className="table-auto min-w-full border-collapse  border border-gray- table ta">
      ...
      <th className="px-4 py-2">
        ...
        <tbody id="set-rows  ">
            {tableData?.map(item => (
                <tr key={item.id}>
                    <td><span className="ml-7">{item.sl}</span></td>
                     <td className="text-sm text-center ">{item.id}</td>

                    <td className=' text-center text-sm'>{item.deliveryManName}</td>
                    <td className='text-center text-sm'> {item.createdAt}</td>
                    <td className='text-center text-sm'> {item.disburseAmount}</td>
    ...
    <table className="table-auto min-w-full border-collapse  border border-gray-200">
      ...
      <th className="px-4 py-2">
        ...
        <tbody id="set-rows  ">
            {tableData?.map(item => (
                <tr key={item.id}>
                    <td><span className="ml-7">{item.id}</span></td>
