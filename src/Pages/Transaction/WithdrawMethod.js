    ...
    <div className="flex items-center justify-between">
      <h1 className="page-header-title flex items-center">
        <span className="page-header-icon mr-2">
          <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/icons/withdraw.png" className="w-[25px] " alt="" />
        </span>
        ...
        <tbody id="set-rows  ">
            {tableData?.map(item => (
                <tr key={item.id}>
                    ...
                    <div>
                    <div>
                    <span className='font-bold p-1'> Name: </span><span>{item.Accountname}</span>
                    </div>
                    <div>
                    <span className='font-bold'> Type: </span><span>{item.type}</span>
                    </div>
                    <div>
                    <span className='font-bold'> Placeholder:<span> {item.Placeholder}</span> </span>
                    </div>
                    ...
                    <i> 
                    <Switch color="#24bac3" // Set default color to #24bac3
