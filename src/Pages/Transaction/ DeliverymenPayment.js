  ...
  <div className="flex items-center justify-between">
      <h1 className="page-header-title flex items-center">
        <span className="page-header-icon mr-2">
          <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/report.png" className="w-[30px] " alt="" />
        </span>
    ...
    <div className=" mt-6">
        <div className="bg-white shadow-md rounded border border-gray-200 px-8 pt-6 pb-8 mb-4">
          <form  method="post" id="add_transaction">
            ...
            <div>
            <div className="mb-4">
                <label htmlFor="type" className="block text-gray-700 text-sm font-bold mb-2">Deliveryman</label>
              ...
              <div className="mb-4">
                <label htmlFor="deliveryman" className="block text-gray-700 text-sm font-bold mb-2">Method</label>
                <input className="form-input border border-gray-300 rounded px-4 w-full py-2 focus:outline-none focus:border-[#24bac3]" type="text" name="method" id="method" required maxLength="191" placeholder="Ex: cash " />
              </div>
            </div>
           
              <div>
              <div className="mb-4">
                <label htmlFor="ref" className="block text-gray-700 text-sm font-bold mb-2">Amount $</label>
                <input className="form-input border w-full border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-[#24bac3]" type="text" name="ref" id="ref" maxLength="191" placeholder="Ex:100 " />
              </div>
              <div className="mb-4">
                <label htmlFor="amount" className="block text-gray-700 text-sm font-bold mb-2">Reference </label>
                <input className="form-input border border-gray-300 rounded px-4 py-2 w-full focus:outline-none focus:border-[#24bac3]" type="text" min=".01" step="0.01" name="amount" id="amount" max="999999999999.99" placeholder="Ex collect cash"  />
              </div>
              </div>  
            </div>
      ...
      <div className="md:flex  items-center justify-between md:gap-4 mt-5 border  ">
        ...
        Deliverymen Earning Provide Table
          <span className="badge badge-soft-dark ml-2 text-sm bg-gray-300 p-1">3</span>
        </span>
      </h1>
...
export default  DeliverymenPayment
