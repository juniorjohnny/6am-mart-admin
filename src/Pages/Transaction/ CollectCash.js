     ...
     <div className="flex items-center justify-between">
      <h1 className="page-header-title flex items-center">
        <span className="page-header-icon mr-2">
          <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/collect-cash.png" className="w-22" alt="" />
        </span>
      ...
      <div className=" mt-6">
        <div className="bg-white shadow-md rounded border border-gray-200 px-8 pt-6 pb-8 mb-4">
          <form  method="post" id="add_transaction">
            <input type="hidden" name="_token" value="VnxlaMa6123NLqwP1UuFryMihM6bSg4fLdbtIrtD" autoComplete="off" className='' />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
            <div className="mb-4">
                <label htmlFor="type" className="block text-gray-700 text-sm font-bold mb-2">Collect from</label>
                <select name="type" id="type" className="form-select border w-full border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-[#24bac3]">
                  <option value="deliveryman">Deliveryman</option>
                  <option value="store">Store</option>
                </select>
              </div>
              <div className="mb-4">
                <label htmlFor="deliveryman" className="block text-gray-700 text-sm font-bold mb-2">Deliveryman</label>
                <select id="deliveryman" placeholder='Select store' name="deliveryman_id" className="form-select border w-full border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-[#24bac3]">
             ...
             <div>
             <div className="mb-4">
                <label htmlFor="store" className="block text-gray-700 text-sm font-bold mb-2">Store</label>
                <select id="store" name="store_id" className="form-select border w-full border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-[#24bac3]" disabled>
                  {/* Options for store */}
                </select>
              </div>
              ...
              <div className="mb-4">
                ...
                <input className="form-input border border-gray-300 rounded px-4 w-full py-2 focus:outline-none focus:border-[#24bac3]" type="text" name="method" id="method" required maxLength="191" placeholder="Ex: Card" />
              </div>
             </div>
             
              <div>
              <div className="mb-4">
                <label htmlFor="ref" className="block text-gray-700 text-sm font-bold mb-2">Reference</label>
                <input className="form-input border w-full border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-[#24bac3]" type="text" name="ref" id="ref" maxLength="191" />
              </div>
              <div className="mb-4">
                <label htmlFor="amount" className="block text-gray-700 text-sm font-bold mb-2">Amount $</label>
                <input className="form-input border border-gray-300 rounded px-4 py-2 w-full focus:outline-none focus:border-[#24bac3]" type="number" min=".01" step="0.01" name="amount" id="amount" max="999999999999.99" placeholder="Ex: 1000" />
              </div>
              </div>
            ...
            <div className="flex justify-end mt-6">
              <button className="bg-gray-400 hover:bg-[#24bac3] text-white font-bold py-2 px-4 rounded mr-2" type="reset" id="reset_btn">Reset</button>
              <button className="bg-[#24bac3] hover:bg-[#56dce3] text-white font-bold py-2 px-4 rounded" type="submit">Collect cash</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div className="md:flex  items-center justify-between md:gap-4 mt-5 border  ">
        ...
        <span>
        Transaction History
          <span className="badge badge-soft-dark ml-2 text-sm bg-gray-300 p-1">6</span>
        </span>
      </h1>
