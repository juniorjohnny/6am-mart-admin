                ...
                <div className='flex md:flex-row flex-col gap-5'>
                    <div className='flex flex-col md:w-1/2 shadow rounded gap-3'>
                        ...
                        <div className='flex flex-col px-5 text-[2vh] gap-2'>
                            <h1>Api Key</h1>
                            <input className='border rounded px-3 h-10' placeholder='' type="text" />
                        </div>
                        <div className='flex flex-col px-5 text-[2vh] gap-2'>
                            <h1>Published Key</h1>
                            <input className='border rounded px-3 h-10' placeholder='' type="text" />
                        ...
                        <div className='flex flex-col px-5 text-[2vh] gap-2'>
                            ...
                            <input className='border rounded px-3 h-10' placeholder='' type="text" value="Stripe" />
                        </div>
                        <div className='self-end px-5 text-[2vh]'>
                            <button className='px-10 py-2 bg-green-900 text-white rounded'>Save</button>
                        </div>
                        <div>
                        </div>
                    </div>
