...
const tableData = [
  ...
  },
  {
    ...
    "imageUrl": "https://6ammart-admin.6amtech.com/storage/app/public/store/2022-03-22-62395f9a68837.png",
    "ratings": 0,
    "totalProducts": 1,
    "totalOrders": 1,
    "statusChecked": true,
    "actionUrl": "https://6ammart-admin.6amtech.com/admin/store/recommended-store-remove/9"
  },
  {
    "id": 6,
    "storeName": "Online market",
    "imageUrl": "https://6ammart-admin.6amtech.com/storage/app/public/store/2022-03-22-6239604ade310.png",
    "ratings": 0,
    "totalProducts": 5,
    "totalOrders": 7,
    "statusChecked": true,
    "actionUrl": "https://6ammart-admin.6amtech.com/admin/store/recommended-store-remove/11"
  },
  {
    "id": 7,
    "storeName": "Eco Market",
    "imageUrl": "https://6ammart-admin.6amtech.com/storage/app/public/store/2022-03-23-623a9cf1ef100.png",
    "ratings": 0,
    "totalProducts": 2,
    "totalOrders": 0,
    "statusChecked": true,
    "actionUrl": "https://6ammart-admin.6amtech.com/admin/store/recommended-store-remove/30"
  }
    ...
    <div>
       <div className='py-3'>
          <h1 className="page-header-title capitalize m-0 flex text-2xl gap-3 font-extrabold">
             ...
             <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/condition.png" className="w-6 h-auto" alt=""></img>
      ...
      <div className="flex justify-end mt-2">
        ...
        <button type="button" className="px-4 py-2 bg-[#24bac3] text-white border rounded hover:bg-[#3d9fa4] focus:outline-none focus:border-[#24bac3]focus:ring focus:ring-blue-200">Sumit</button>
      </div>
            ...
            <div className='py-1 '>
                <h1 className="page-header-title capitalize m-0 text-[18px] flex   font-extrabold">
                    <span >
                        ...
                        <span className="badge badge-soft-dark ml-2 text-sm bg-slate-300 p-1">7</span>
                    </span>
                </h1>
            </div>
