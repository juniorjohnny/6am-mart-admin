    ...
    <>
      ...
      <div className="max-w-full mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        >
          ...
          <button className="btn bg-[#f3f4f5] hover:bg-[#DBDCDC]">Reset</button>
          <button className="btn bg-[#24bac3] hover:bg-[#20A7AF] text-white ">Sumit</button>
          </div>
        </form>
      </div>
        ...
        <div className="card shadow-lg p-2">
          <div className="card-header py-3 border-b-0 flex justify-between items-center">
            ...
            <form className="search-form flex items-center">
              ...
              <button
                type="submit"
                className="border py-2 rounded-r-lg px-4"
              >
              <SearchIcon/>
              </button>
            </form>
              ...
              <tbody id="set-rows">
                {banners.map((banner, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 text-center">
                      <button className="btn btn-sm btn-outline hover:bg-[#24bac3]  text-[#24bac3]   mr-2"> <EditIcon/></button>
                      <button className="btn btn-sm  btn-outline btn-error "><DeleteIcon/></button>
                    </td>
                  </tr>
                ))}
              </tbody>
