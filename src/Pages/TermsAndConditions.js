    ...
    return (
        <div className='h-full w-auto'>
            <div className='px-5 py-3 flex gap-3'>
                <a onClick={() => navigate('/privacy_policy')}><h1>Privacy Policy</h1></a>
                <a onClick={() => navigate('/terms_and_conditions')}><h1 >Terms & Conditions</h1></a>
            </div>
            <div className='shadow rounded flex flex-col'>
                ...
                <div className='self-end w-fit px-5 py-3'>
                    <button className='bg-sky-500 rounded px-10 font-semibold py-2 text-white'>Save</button>
