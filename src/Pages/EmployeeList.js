...
const columns = [
  ...
  { field: "Action", headerName: "Action", width: 130, renderCell: (parms) => (
...
const rows = [
  { id: 1, SL: "1", Name:"	Ronnie Dickson",Email:"	D**********@gmail.com",Phone:"	0**********",Role:"	Receptionist & Front Desk Manager",Action:"true" },
