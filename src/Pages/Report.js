...
const rows = [
  { id: 1, SL: 1, TransactionId: "451c323d-c3c7-4b67-9f14-bf4e2163a252",CustomerInfo:"	Marjahan Sultana",Credit: 0.00,	Debit:858.40,	Bonus: 0.00,Balance:4441.60 ,	TransactionType:"Order Place",Reference:	100099,	CreatedAt:"02 Jan 202404:54:pm" },
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="card-header flex  gap-3 border p-2">
          <div className="search--button-wrapper flex flex-wrap justify-between md:w-full max-w-[] mb-4">
            ...
            <div className=""><SearchBox placeholder={"Ex:Search by Customer Number"}/></div>
              <form
                className="search-form theme-style"
              >
