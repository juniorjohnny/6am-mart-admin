    ...
    const rows = [
        { id: 1,SL:1,BonusTitle:"Add 100 get 10% Extras",BonusInfo:"Minimum add amount - $ 500.00 Maximum bonus - $ 300.00",BonusAmount:"10 (%)",ExpriedOn:"21 Jul 2027",Status:true,Action:true     },
    ...
    return (
        ...
        <Card className="max-w-[400px] overflow-auto md:max-w-full" style={{ height: 400, width: "100%" }}>
            <DataGrid
            rows={rows}
            columns={columns}
            initialState={{
