    ...
    <div className='h-full w-full'>
        <div className='flex flex-col gap-3'>
                ...
                <div className='flex flex-col justify-between px-5 shadow py-5 gap-8 text-[2vh]'>
                    ...
                    <div className='flex flex-col gap-1 w-1/2'>
                        <label className='font-semibold' htmlFor="">Social Media Links</label>
                        <input className='h-10 rounded border px-3' placeholder='Enter URL' type="text" />
                    </div>
                    </div>
        ...
        <tbody id="set-rows  ">
            {tableData?.map(item => (
                <tr key={item.id}>
                    ...
                    <td className='flex text-center gap-1 items-center ml-5 p-3'><i className="  "></i>https://www.instagram.com/?hl=en</td>
