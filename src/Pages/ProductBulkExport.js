 ...
 <div>
    ...
    <div className="border-2 p-1 rounded mt-2  shadow-md ">
        ...
        <div className="bg-white shadow-md rounded-md p-6 flex-grow border mx-3 py-5" >
          <div className="export-steps-item-2 h-full">
            <div className="top flex justify-between items-center">
              ...
              <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/bulk-export-1.png" alt="" className="w-18 h-auto"></img>
              
            </div>
            <h4 className='font-bold'>Instruction</h4>
            <ul className="m-0 pl-4 py-4">
              <li className='list-disc py-2'>Select data type in which order you want your data sorted while downloading.</li>
          ...
          <div className="export-steps-item-2 h-full">
            <div className="top flex justify-between items-center">
              <div>
                ...
                <div className='text-sm py-5'>Select Data Range by Date or ID and Export</div>
              </div>
              <img src="https://6ammart-admin.6amtech.com/public/assets/admin/img/bulk-export-2.png" alt="" className="w-18 h-auto" ></img>
            </div>
            <h4 className='font-bold'>Instruction</h4>
            <ul className="m-0 pl-3 py-3">
              <li className='list-disc py-2'>The file will be downloaded in .xls format</li>
              <li className='list-disc py-2'>Click reset if you want to clear you changes and want to download in default sort wise data</li>
      ...
      <div className="form-group w-full">
        <label className="input-label ml-4 " htmlFor="type">Type</label>
        <select name="type" id="type" className="form-select block  md:w-1/3 w-full  p-3  mt-2  border border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required title="Select Type">
    ...
    <div className="flex justify-end mt-5 mr-2 mb-4">
      <button className="px-6 py-2 mr-3 border rounded text-gray-700 hover:bg-gray-100 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200" id="reset-btn" type="reset">Clear</button>
      <button className="px-6 py-2 bg-[#24BAC3] text-white border rounded hover:bg-[#20A7AF] focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200" type="submit">Export</button>
    </div>
