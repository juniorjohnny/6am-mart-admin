...
<FiberManualRecordIcon style={{ fontSize: '4px', color: 'white',marginLeft:'4px' }}/>
        ...
        <Link to="users/contact/contact-list">
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemIcon>
        ...
        <Link className="" to="users/custom-role/create">
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemIcon>
        ...
        <ListItem disablePadding sx={{ display: "block" }}>
          ...
          >
            ...
            <ListItemText className="-mx-2" primary="Employee" sx={{ opacity: open ? 1 : 0 }} />
