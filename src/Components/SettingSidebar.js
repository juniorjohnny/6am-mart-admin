...
const ModuleSetup = [
    { to: "/business-settings/moduleSetup/AddBusinessModule", label: "Add Business Module" },
  ...
  const ThirdrdParty  = [
    ...
    { to: "/business-settings/FirebaseNotification", label: "Firebase Notification" },
  ...
  return (
    <>
     ...
     <div className="flex justify-start items-center mx-2 text-sm mt-4 text-[#99A7BA]">
        ...
        <Link to="/business-settings/zoneSetup">
...
<FiberManualRecordIcon style={{ fontSize: '4px', color: 'white',marginLeft:'4px' }}/>
        ...
        <Link to={"/business-settings/business-setup"}>
        <ListItem disablePadding sx={{ display: "block" }}>
          <ListItemButton
        ...
        <Link to="/users/customer/subscribed">
          <ListItem disablePadding>
            <ListItemButton>
              <ListItemIcon>
        ...
        <ListItem disablePadding sx={{ display: "block" }}>
          ...
          >
            ...
            <ListItemText className="-mx-2" primary="3rd Party & Configuration" sx={{ opacity: open ? 1 : 0 }} />
